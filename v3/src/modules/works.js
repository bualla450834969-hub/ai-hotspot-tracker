...
(function() {
  ...
  function renderAuthors(works) {
    ...
    // 提取内容主题关键词
    const themeKeywords = ['可灵','即梦','AI绘画','AI视频','数字人','工作流','Agent','提示词','教程','实测','对比','免费','神器','效率','自动化','Sora','Midjourney','ComfyUI','Dify','Coze','豆包','GPT','Claude','剪映','PPT','电商','带货','变现','副业','编程','代码','写作','翻译','配音','音乐','图片','头像','壁纸','表情包','游戏','动漫','影视','解说','测评','盘点','干货','避坑','新手','入门','进阶','高阶','开源','GitHub','模型','大模型','LLM','RAG','微调','训练'];
    // 内容形式标签
