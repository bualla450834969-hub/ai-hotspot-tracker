...
window.DOMAIN_CONFIG = {
  ...
  lead_scripts_detail: [
    { hook: '你写的字为什么总是不好看？', body: '今天教你一个简单技巧，让你的字立刻提升一个档次。', cta: '关注我，每天分享书法干货。' },
    { hook: '练了这么久书法，你可能一直在走弯路。', body: '这几个常见误区，看看你中了几个。', cta: '点赞收藏，避免踩坑。' },
    { hook: '零基础也能写好字，关键在于方法。', body: '跟着我这样练，一个月就能看到明显变化。', cta: '评论区打卡，一起进步。' },
  ],
  ...
  // ===== 标签 =====
  hashtags: ['#书法', '#练字', '#毛笔字', '#硬笔书法', '#楷书', '#行书', '#书法教学', '#每日一练', '#传统文化', '#写字'],
  ...
  // ===== 人群画像 =====
  audience_personas: [
    { name: '学生党', age: '12-22岁', need: '练字提升卷面分/考级', content: '硬笔教学、考级辅导', monetization: '字帖、课程' },
    { name: '职场人', age: '25-40岁', need: '修身养性/签名好看', content: '快速练字技巧、行书教学', monetization: '教程、工具' },
    { name: '退休人群', age: '55-70岁', need: '兴趣爱好/社交', content: '毛笔入门、作品展示', monetization: '工具、社群' },
    { name: '书法爱好者', age: '20-50岁', need: '进阶提升/交流', content: '名家赏析、技巧干货', monetization: '高阶课程、工具' },
  ],
